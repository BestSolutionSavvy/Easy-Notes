...
Ogni blocco di appunti può essere poi salvato direttamente insieme alle relative slide, sia in
locale che sul cloud. \\
...
tramite tecniche di machine learning, in modo da facilitare lo studio in vista degli esami. \\
In questo report verranno descritte le varie fasi di sviluppo del progetto, dalle
scelte tecnologiche al design dell'architettura, fino ai test effettuati su utenti reali e 
al deployment della Web App.