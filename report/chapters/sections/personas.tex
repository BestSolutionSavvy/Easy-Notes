...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item In alcune slide aggiunge post-it ed evidenziazioni per ricordarsi concetti importanti espressi dal professore.
        \item Al termine della lezione salva appunti e slide sul cloud.
    \end{enumerate}
\end{itemize}
