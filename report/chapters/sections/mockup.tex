...
Per questo motivo, la pagina principale in Figura \ref{fig:mockup_home} dell'applicazione è 
...
sono presenti i comandi per la gestione delle note, come il salvataggio e l'apertura di un notebook.\\
...
\begin{itemize}
    ...
    \item Classes, la pagina dove l'utente può visualizzare tutte le classi.
...
Ogni pagina necessita di un account per essere visualizzata.
