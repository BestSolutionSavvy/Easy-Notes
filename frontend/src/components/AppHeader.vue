    ...
    <div>
        ...
        <Transition name="slide">
            <div
                ...
                style="top: 70px; left: 10px; height: calc(100vh - 80px);"
            >
        ...
        <header
            ...
            <img src="../assets/menuIcon.svg" class="w-5 h-4 cursor-pointer" @click="toggleMenu"></img>
            <h1 class="text-white text-2xl font-semibold font-['Inter']">Easy Notes</h1>
        </header>
    </div>
</template>
