    ...
    <div class="p-4 space-y-4">
      ...
      >
        ...
        <div class="space-y-1.5">
          ...
          >
            <kbd class="inline-flex items-center justify-center px-2.5 py-1 text-[11px] font-bold text-gray-700 bg-gradient-to-b from-gray-50 to-gray-100 border border-gray-300 rounded-md shadow-sm min-w-[70px] group-hover:border-orange-400 group-hover:shadow-md transition-all">
              {{ shortcut.key }}
            </kbd>
